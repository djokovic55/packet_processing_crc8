...
proc create_outmem_help {} {
	task -create pb0_di_outmem_help -set -source_task <embedded> -copy_stopats -copy_ratings -copy_abstractions all -copy_assumes -copy <embedded>::top.chk_top.ast_pb0_di

	set byte0 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 0 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 2\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 0\))"
	set byte1 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 1 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 3\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 1\))"
	set byte2 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 2 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 4\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 2\))"
	set byte3 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 3 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 5\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 3\))"
	set byte4 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 4 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 6\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 4\))"
	set byte5 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 5 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 7\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 5\))"
	set byte6 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 6 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 8\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 6\))"
	set byte7 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 7 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 9\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 7\))"
	set byte8 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 8 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 10\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 8\))"
	set byte9 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 9 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 11\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 9\))"
	set byte10 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 10 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 12\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 10\))"
	set byte11 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 11 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 13\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 11\))"
	set byte12 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 12 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 14\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 12\))"
	set byte13 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 13 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 15\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 13\))"
	set byte14 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 14 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 16\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 14\))"
	set byte15 "(subsys.packet_builder0.irq_O = 1 and chk_top.pb_byte_cnt >= 15 and chk_top.pb0_checker_en) |-> (outmem.inmem_bram.ram_s\(chk_top.pb_addr_out + 17\) = inmem.inmem_bram.ram_s\(chk_top.pb_addr_in + 15\))"

	 assert -helper -name ast_pb0_b0_di_outmem_help $byte0
	 assert -helper -name ast_pb0_b1_di_outmem_help $byte1
	 assert -helper -name ast_pb0_b2_di_outmem_help $byte2
	 assert -helper -name ast_pb0_b3_di_outmem_help $byte3
	 assert -helper -name ast_pb0_b4_di_outmem_help $byte4
	 assert -helper -name ast_pb0_b5_di_outmem_help $byte5
	 assert -helper -name ast_pb0_b6_di_outmem_help $byte6
	 assert -helper -name ast_pb0_b7_di_outmem_help $byte7
	 assert -helper -name ast_pb0_b8_di_outmem_help $byte8
	 assert -helper -name ast_pb0_b9_di_outmem_help $byte9
	 assert -helper -name ast_pb0_b10_di_outmem_help $byte10
	 assert -helper -name ast_pb0_b11_di_outmem_help $byte11
	 assert -helper -name ast_pb0_b12_di_outmem_help $byte12
	 assert -helper -name ast_pb0_b13_di_outmem_help $byte13
	 assert -helper -name ast_pb0_b14_di_outmem_help $byte14
	 assert -helper -name ast_pb0_b15_di_outmem_help $byte15
