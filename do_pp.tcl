...
# verif
analyze -sv09 checker_pp.sv checker_inmem.sv checker_axi.sv bind_pp_mem.sv

# src
analyze -vhdl master_axi_cont.vhd packet_parser.vhd data_memory.vhd slave_axi_cont.vhd bram.vhd 
