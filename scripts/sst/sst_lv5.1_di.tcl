...
assert -set_helper *subtarget_help*
...
assert -mark_proven *subtarget_help*

# Generate SST trace

# prove -property *ast_packet_integrity -sst 10 -set helper
# prove -property *subtarget -sst 5 -set helper
# Prove target property with helpers
# prove -property *ast_pb0_di -with_helpers
prove -property *subtarget* -with_helpers -bg

# Check new helpers
task -create lv5.1_G -set -source_task <embedded> -copy_stopats -copy_ratings -copy_abstractions all -copy_assumes -copy {<embedded>::top.chk_top.*subtarget_help_new*}
prove -bg -task {lv5.1_G}
